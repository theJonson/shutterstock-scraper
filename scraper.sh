...
#Set API KEY
KEY=""
...
curl -s -X GET https://api.shutterstock.com/v2/editorial/images/updated -H "Accept: application/json" -G -H "$API_KEY" --data-urlencode "type=addition" --data-urlencode "country=GBR" --data-urlencode "supplier_code=SPTQ" --data-urlencode "date_updated_start=2021-03-09T00:00:01Z" --data-urlencode "date_updated_end=2021-03-09T23:59:59Z" | jq -r '.data[] | .id' > $WORK/image_ids.txt
